...
class BookingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddBooking = channel.unary_unary(
                '/Booking/AddBooking',
                request_serializer=booking__pb2.AddBookingParameter.SerializeToString,
...
def add_BookingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AddBooking': grpc.unary_unary_rpc_method_handler(
                    servicer.AddBooking,
                    request_deserializer=booking__pb2.AddBookingParameter.FromString,
...
class Booking(object):
    ...
    def AddBooking(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Booking/AddBooking',
            booking__pb2.AddBookingParameter.SerializeToString,
