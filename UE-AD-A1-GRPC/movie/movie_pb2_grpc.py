...
class MovieStub(object):
    ...
    def __init__(self, channel):
        ...
        self.EditMovie = channel.unary_unary(
                '/Movie/EditMovie',
                request_serializer=movie__pb2.EditData.SerializeToString,
                response_deserializer=movie__pb2.MovieData.FromString,
                )
...
def add_MovieServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'EditMovie': grpc.unary_unary_rpc_method_handler(
                    servicer.EditMovie,
                    request_deserializer=movie__pb2.EditData.FromString,
                    response_serializer=movie__pb2.MovieData.SerializeToString,
            ),
    }
...
class Movie(object):
    ...
    def EditMovie(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Movie/EditMovie',
            movie__pb2.EditData.SerializeToString,
            movie__pb2.MovieData.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
